    ...
    def _pr_diff_context(
        ...
        *,
        ...
        full_result = {
            ...
            "touched_symbols": [self._asdict_symbol(s) for s in primary_touched_symbols],
            "container_symbols": [self._asdict_symbol(s) for s in container_symbols],
            "all_touched_symbols": [self._asdict_symbol(s) for s in all_touched_symbols],
...
def _partition_symbols_touched_by_diff(
    query: QueryEngine, changed_lines: dict[str, set[int]]
...
def _pr_risk_weight(symbol: Any) -> float:
